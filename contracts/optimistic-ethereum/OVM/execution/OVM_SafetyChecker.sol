        ...
        do {
            ...
            if (opBit & opcodeGateMask == 0) {
                if (opBit & opcodePushMask == 0) {
                    ...
                    // CALLER PUSH1 0x0 SWAP1 GAS CALL PC PUSH1 dec14 ADD JUMPI RETURNDATASIZE PUSH1 0x00 DUP1 RETURNDATACOPY RETURNDATASIZE PUSH1 0x00 REVERT JUMPDEST RETURNDATASIZE PUSH1 0x01 EQ ISZERO PC PUSH1 0x0a ADD JUMPI PUSH1 0x01 PUSH1 0x00 RETURN JUMPDEST 
